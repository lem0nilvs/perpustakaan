...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Rahmawati Azizah A"; ?></p>
        ...
        $nama_perpus   = "Perpustakaan Universitas Nusantara";
        $total_buku    = 2250;
        $total_anggota = 500;
        $buku_dipinjam = 335;
        $buku_tersedia = $total_buku - $buku_dipinjam;
        $persen_pinjam = round(($buku_dipinjam / $total_buku) * 100, 1); // Persentase buku dipinjam
        $persen_tersedia = round(($buku_tersedia / $total_buku) * 100, 1); // Persentase buku tersedia
        

        // Variabel tambahan buat informasi perpus
